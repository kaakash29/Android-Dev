...
public class AudioVideoCameraActivity extends Activity {
	...
	Camera.PictureCallback mPictureCallback = new Camera.PictureCallback() {
		...
		public void onPictureTaken(byte[] data, Camera camera) {
			...
			System.out.println("Reached the point for Saving photos");
			...
			File file = new File(mydir.toString() + "/"+timeStamp + ".jpg");
			...
			if (file.exists()){
				System.out.println("Image file was created successfully ... " + file.toString());
			}
			
		    try {
		        FileOutputStream out = new FileOutputStream(file);
		        Bitmap imageToSave = BitmapFactory.decodeByteArray(data , 0, data .length);
