...
public class ActivityLoaderActivity extends Activity {
    ...
    static private int EXPLICIT_ACTIVATION_RQST = 2; 
	@Override
	...
	private void startExplicitActivation() {
		...
		try {
			// trying to start the activity with the given intent and 
			// expecting a positive result
			startActivityForResult(explicitIntent, EXPLICIT_ACTIVATION_RQST); 
			
        	} catch (ActivityNotFoundException E) {
        	
        	Log.i(TAG,"DEBUG : Activity NOT Found Exception Occured");	
        }
	...
	private void startImplicitActivation() {
        ...
        Log.i(TAG, "DEBUG : Base Intent Created");
		...
		Log.i(TAG, "DEBUG : Chooser Intent Created");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if ((requestCode == EXPLICIT_ACTIVATION_RQST)
		&&  (resultCode == RESULT_OK)) {
			
			mUserTextView.setText ((String)data.getExtras().get("USER_TXT"));
		}   
    }
}
